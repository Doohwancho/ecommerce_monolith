...
//                //total 100-ish rows
//            int batchSize = 1000;
//            int numberOfUsers = 10; //2,000 * 3 (user, address, user_authority, order ㅅㅜ 결정)
...
//            int numberOfProductItemsPerProduct = 3; //12,000 (4000 from products * 3)
//            int numberOfDiscountsPerProductItem = 1; //12,000 (1:1 ratio, productItem : discount)
//            int numberOfProductOptionVariationPerProductItem = 1; //12,000 (1:1 ratio, productItem : productOptionVariation)
//            int numberOfOrderItemsPerOrder = 2; //2000 (number of orders * 2)
//
//                //total 53,000 rows
////                int batchSize = 1000;
...
//                //total 104,000 rows
////            int batchSize = 1000;
////            int numberOfUsers = 4000; //4,000 * 3 (user, address, user_authority)
////            int numberOfLowCategoriesPerMidCategories = 5; //75
////            int numberOfOptions = 3; //180
////            int numberOfOptionVariations = 3; //540
////            int numberOfProducts = 8000; //8,000
////            int numberOfProductItemsPerProduct = 3; //24,000
////            int numberOfDiscountsPerProductItem = 1; //24,000
////            int numberOfProductOptionVariationPerProductItem = 1; //24,000
////            int numberOfOrderItemsPerOrder = 2; //4000 + 8000 (order, orderItem)
//
