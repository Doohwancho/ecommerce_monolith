package com.cho.ecommerce.global.config.bulk_insert.fakedata;

import com.cho.ecommerce.global.config.bulk_insert.fakedata.step2_jdbc_bulk_insert.JdbcFakeDataGenerator;
...
public class BulkInsertController {
    ...
    public ResponseEntity<String> bulkInsert(@PathVariable("amount") String amount)
        ...
        //if baseAmount is 100,000? -> total: 1,600,000 rows
        //users: 100,000
        //address: 100,000
        ...
        //if baseAmount is 1,000,000? -> total: 16,000,000 rows
        //users: 1,000,000
        //address: 1,000,000
