...
//@Threads(4)
public class PrimitiveArrayViewCounterBenchmark {
    
    private PrimitiveArrayViewCounter viewCounter;
    ...
    @Setup
    public void setup() {
        viewCounter = new PrimitiveArrayViewCounter(MAX_PRODUCT_ID);
    ...
    @Benchmark
    @Group("array_optimized_read")
    @GroupThreads(2)
    public void readTest(Blackhole blackhole) {
        blackhole.consume(viewCounter.getTopNProductIds(10));
    }
