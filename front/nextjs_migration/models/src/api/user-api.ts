...
// @ts-ignore
import type { LoginPage200Response } from '../../src/model';
// @ts-ignore
import type { LoginRequestDTO } from '../../src/model';
// @ts-ignore
import type { LoginResponseDTO } from '../../src/model';
// @ts-ignore
import type { LoginUser401Response } from '../../src/model';
// @ts-ignore
import type { RegisterRequestDTO } from '../../src/model';
// @ts-ignore
import type { RegisterResponseDTO } from '../../src/model';
// @ts-ignore
import type { RegisterRoleUserDefaultResponse } from '../../src/model';
// @ts-ignore
import type { UserDetailsResponseDTO } from '../../src/model';
/**
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        loginPage: async (logout?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        loginUser: async (loginRequestDTO: LoginRequestDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        registerRoleUser: async (registerRequestDTO: RegisterRequestDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserByUsername(username: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserDetailsResponseDTO>> {
         ...
         * @throws {RequiredError}
         */
        async loginPage(logout?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoginPage200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.loginPage(logout, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UserApi.loginPage']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Authenticates the user and returns a login status message.
         ...
         * @throws {RequiredError}
         */
        async loginUser(loginRequestDTO: LoginRequestDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoginResponseDTO>> {
         ...
         * @throws {RequiredError}
         */
        async registerRoleUser(registerRequestDTO: RegisterRequestDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegisterResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.registerRoleUser(registerRequestDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UserApi.registerRoleUser']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export interface UserApiInterface {
     ...
     */
    getUserByUsername(username: string, options?: RawAxiosRequestConfig): AxiosPromise<UserDetailsResponseDTO>;
     ...
     * @memberof UserApiInterface
     */
    loginPage(logout?: string, options?: RawAxiosRequestConfig): AxiosPromise<LoginPage200Response>;
     ...
     * @memberof UserApiInterface
     */
    loginUser(loginRequestDTO: LoginRequestDTO, options?: RawAxiosRequestConfig): AxiosPromise<LoginResponseDTO>;
     ...
     * @memberof UserApiInterface
     */
    registerRoleUser(registerRequestDTO: RegisterRequestDTO, options?: RawAxiosRequestConfig): AxiosPromise<RegisterResponseDTO>;
...
export class UserApi extends BaseAPI implements UserApiInterface {
     ...
     * @memberof UserApi
     */
    public loginPage(logout?: string, options?: RawAxiosRequestConfig) {
     ...
     * @memberof UserApi
     */
    public loginUser(loginRequestDTO: LoginRequestDTO, options?: RawAxiosRequestConfig) {
     ...
     * @memberof UserApi
     */
    public registerRoleUser(registerRequestDTO: RegisterRequestDTO, options?: RawAxiosRequestConfig) {
